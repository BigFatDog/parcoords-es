import {eventm, select} from "d3-selection";
import {drag} from "d3-drag";
import onDragEnd from './onDragEnd';

const drawStrum =(brushGroup, state, config, pc, events, strum, activePoint)=> {
    ...
    circles
        ...
        .attr('cy', d=>d[1])
        .attr('r', 5)
        .style('opacity', (d, i)=>activePoint !== undefined && i === activePoint ? 0.8 : 0)
...
const onDrag = (brushGroup, state, config, pc, events)=> function() {
    const ev = event,
